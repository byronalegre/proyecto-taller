...
<li class="breadcrumb-item">
	<a href="{{url('/admin/remitos/agregar') }}"><i class="fas fa-plus-circle"></i> Nuevo remito</a>
</li>
@endsection
...
<div class="container-fluid" oncontextmenu="return false"><!-- ONCONTEXTMENU DESACTIVA F12-->
	<div class="panel shadow">
		...
		<div class="inside">
			{!! Form::open(['url' => '/admin/remitos/agregar','files'=>true,'id'=>'formulario']) !!}	
				<div class="row">
					<div class="col-md-6">
							...
							<div class="input-group">								
						    	...
						    	{!!Form::select('orden_id', $code, null, ['class' =>'form-select', 'id'=>'orden_id', 'placeholder'=>'Seleccione una ODC']) !!}
						    </div>
					</div>
					...
					<div class="col-md-6">
							...
							<div class="input-group">								
						    	...
						    	{!!Form::select('proveedor', $provs, null, ['class' =>'form-select', 'id'=>'prov_id']) !!}
						    </div>
					</div>
