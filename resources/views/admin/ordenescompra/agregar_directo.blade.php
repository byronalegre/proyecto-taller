...
<li class="breadcrumb-item">
	<a href="{{url('/admin/ordenescompra/agregar/'.$id) }}"><i class="fas fa-plus-circle"></i> Nueva Orden</a>
</li>
@endsection
...
<div class="container-fluid">
	<div class="panel shadow">
		...
		<div class="inside">
			{!! Form::open(['url' => '/admin/ordenescompra/agregar/'.$id,'files'=>true,'id'=>'formulario']) !!}	
				<div class="row">
					...
					<div class="col-md-4">
							<label for="status">Estado:</label>
								<div class="input-group">									
							    	...
							    	{!!Form::select('status', ['0'=>'Pendiente'/*, '1'=>'Aprobada'*/, '1'=>'Completada'], 0, ['class' =>'form-select']) !!}	
								</div>
					</div>
					<div class="col-md-12">
					...
					{{-- <div class="row mtop16" style="justify-content: center;">
						<div class="col-md-6">
							<div class="card border-warning" style="text-align: center; display: none;" id="card">
							  <div class="card-header bg-warning text-dark">Detalle de Orden de Pedido [Pendiente]</div>
							  <div class="card-body">
							  	<dl class="list-group">
								</dl>
							  </div>
