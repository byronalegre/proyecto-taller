...
<li class="breadcrumb-item">
	<a href="{{url('/admin/ordenespedido/') }}"><i class="fas fa-file-invoice"></i> Ordenes de Pedido</a>
</li>
<li class="breadcrumb-item">
			...
			{!! Form::open(['url' => '/admin/ordenespedido/'.$op->id.'/edit','files'=>true,'id'=>'formulario']) !!}	
				<div class="row">
					...
					<div class="col-md-6">
							<label for="codigo">Código:</label>
						    	...
						    	{!!Form::text('codigo', $op->codigo, ['class' => 'form-control', 'disabled'] ) !!}
						    	</div>
					</div>
				...
				<div class="row mtop16">
					<div class="col-md-12">
						...
						<div class="input-group">
						 	<textarea class="form-control" name="descripcion" rows="3" id="descripcion">{{$op->descripcion}}
						 	</textarea>
					    </div>
					</div>
				</div>										 
