...
<body>
	  ...
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <a href="{{ url('/logout') }}" style="background-color: red;" class="btn">Si
			</a>
	      </div>
	    </div>
	  </div>
	...
	<nav class="navbar navbar-expand-lg">
	  <div class="container-fluid">
	    <a class="navbar-brand" href="{{url('/')}}" ><img src="{{url('static/images/logo1.png')}}" width="50" alt="" loading="lazy"></a>
	    <div>
	    @if(Auth::check())  
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">	
	        <li class="nav-item dropdown">
	          <a class="nav-link dropdown-toggle bg-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
	            <i class="fas fa-user-astronaut"></i> {{ Auth::user()->name.' '.Auth::user()->lastname }}
	          </a>
		...
		<div class="card text-center">
		  <div class="card-body">
		    ...
		    @if(!Auth::check())
			    ...
			    <a href="{{ url('/login') }}" class="btn shadow"><i class="fas fa-sign-in-alt"></i> Ingresar</a>
		    @endif
		    ...
		    @if(Auth::check())		    	
					@if((Auth::user()->role == "1")||(Auth::user()->role == "2")||(Auth::user()->role == "3")|(Auth::user()->role == "4"))
						...
						<a href="{{ url('/admin') }}" class="btn"><i class="fas fa-user-tie"></i> Administración</a>
					@endif
					@if(Auth::user()->role == "0")
