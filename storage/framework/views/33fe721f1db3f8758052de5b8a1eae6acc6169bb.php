...
<li class="breadcrumb-item">
	<a href="<?php echo e(url('/admin/remitos/agregar/'.$id)); ?>"><i class="fas fa-plus-circle"></i> Nuevo remito</a>
</li>
...
<div class="container-fluid" oncontextmenu="return false"><!-- ONCONTEXTMENU DESACTIVA F12-->
	<div class="panel shadow">
		...
		<div class="inside">
			<?php echo Form::open(['url' => '/admin/remitos/agregar/'.$id,'files'=>true,'id'=>'formulario']); ?>	
				<div class="row">
					<div class="col-md-6">
							...
							<div class="input-group">								
						    	...
						    	<?php echo Form::text('orden_id', $orden->codigo, ['class' =>'form-control', 'id'=>'orden_id', 'readOnly']); ?>
					...
					<div class="col-md-6">
							...
							<div class="input-group">								
						    	...
						    	<?php echo Form::select('proveedor', $provs, $orden->proveedor_id, ['class' =>'form-select']); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\www\cms\resources\views/admin/remitos/agregar_directo.blade.php ENDPATH**/ ?>