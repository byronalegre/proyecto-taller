...
<li class="breadcrumb-item">
	<a href="<?php echo e(url('/admin/ordenespedido/agregar')); ?>"><i class="fas fa-plus-circle"></i> Nueva orden</a>
</li>
...
<div class="container-fluid">
	<div class="panel shadow">
		...
		<div class="inside">			
			<?php echo Form::open(['url' => '/admin/ordenespedido/agregar','files'=>true]); ?>	
				<div class="row">
					<div class="col-md-12">
						<label for="fecha_prog">Fecha programada:</label>
					    	...
					    	<?php echo Form::date('fecha_prog', now(), ['class' => 'form-control'] ); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\www\cms\resources\views/admin/ordenespedido/agregar.blade.php ENDPATH**/ ?>