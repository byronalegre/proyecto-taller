...
<li class="breadcrumb-item">
	<a href="<?php echo e(url('/admin/tareas/'.$t->id.'/edit')); ?>"><i class="fas fa-edit"></i> Editar tarea</a>
</li>
...
<div class="container-fluid">
	<div class="panel shadow">
		...
		<div class="inside">
			<?php echo Form::open(['url' => '/admin/tareas/'.$t->id.'/edit','files'=>true,'id'=>'formulario']); ?>	
				<div class="row">
					<div class="col-md-4">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\www\cms\resources\views/admin/tareas/edit.blade.php ENDPATH**/ ?>