...
<head>
	...
	<body>
				...
				Reporte de Ordenes de Pedido  del año <?php echo e(now()->format('Y')); ?>				
				</h2>
				<div style="font-family: Tahoma, sans-serif; font-size: 10px;">Cantidad de items: <?php echo e(count($op->all())); ?>
				...
				<table style="font-family: Tahoma, sans-serif; width: 100%; border: 1px solid black;">
					...
					<tbody style="font-size: 12px; border-top: 1px solid black;">
						<?php $__currentLoopData = $op; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
...
<?php /**PATH G:\www\cms\resources\views/admin/ordenespedido/ordenespedido_ano_pdf.blade.php ENDPATH**/ ?>