...
<li class="breadcrumb-item">
	<a href="<?php echo e(url('/admin/ordenescompra/agregar/'.$id)); ?>"><i class="fas fa-plus-circle"></i> Nueva Orden</a>
</li>
...
<div class="container-fluid">
	<div class="panel shadow">
		...
		<div class="inside">
			<?php echo Form::open(['url' => '/admin/ordenescompra/agregar/'.$id,'files'=>true,'id'=>'formulario']); ?>	
				<div class="row">
				...
				<div class="row mtop16" style="justify-content: center;">
					<div class="col-md-6">
						<div class="card border-warning border-3" id="card">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\www\cms\resources\views/admin/ordenescompra/agregar_directo.blade.php ENDPATH**/ ?>